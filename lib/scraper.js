...
class Scraper extends Transformer {
    constructor() {
        super()
...
--${boundary}--`
        ...
        const { responseBody } = await this.scheduler.request({ method: 'POST', uri: 'https://backend-dot-try-puppeteer.appspot.com/run', headers, body })
