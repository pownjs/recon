exports.yargs = {
    ...
    builder: (yargs) => {
        ...
        yargs.options('select', {
            alias: 's',
            type: 'string',
            describe: 'Select graph. Nodes will be added only if graph contains at least one node.',
            default: ''
        })
        ...
        yargs.options('traverse', {
            alias: 'v',
            type: 'string',
            describe: 'Traverse graph. Nodes will be added only if graph contains at least one node.',
            default: false
        })
