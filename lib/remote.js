...
class RemoteTransform extends Transformer {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        const result = await this.request(method, url, body, variables)
        ...
        if (continuationIdPath && continuationUrl) {
            ...
            if (continuationId) {
                ...
                while (true) {
                    ...
                    const result = await this.request(continuationMethod, continuationUrl, continuationBody, continuationVariables)
