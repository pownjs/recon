...
class Recon extends EventEmitter {
    ...
    async * transformIt(transformation, options = {}, settings = {}) {
        const { transformConcurrency = Infinity, nodeConcurrency = Infinity, timeout = 0, group = false, filter, extract, maxNodesWarn = this.maxNodesWarn, maxNodesCap = this.maxNodesCap, optionsInstance = this.optionsInstance } = settings
