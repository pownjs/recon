...
const bitbucketListRepos = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }) {
        ...
        const { responseBody } = await bitbucketApiScheduler.tryFetch(`https://api.bitbucket.org/2.0/repositories/${search}`, this.headers)
...
const bitbucketListSnippets = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }) {
        ...
        const { responseBody } = await bitbucketApiScheduler.tryFetch(`https://api.bitbucket.org/2.0/snippets/${search}`, this.headers)
...
const bitbucketListTeamRepos = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        const { responseBody } = await bitbucketApiScheduler.tryFetch(`https://api.bitbucket.org/2.0/teams/${search}/repositories`, this.headers)
...
const bitbucketListTeamMembers = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        const { responseBody } = await bitbucketApiScheduler.tryFetch(`https://api.bitbucket.org/2.0/teams/${search}/members`, this.headers)
