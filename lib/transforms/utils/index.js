...
const prefix = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        if (prefix) {
            ...
            results.push({ type: newType, id: this.makeId(newType, newLabel), label: newLabel, label, props: {}, edges: [{ source, type: 'prefix' }] })
        }
...
const suffix = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        if (suffix) {
            ...
            results.push({ type: newType, id: this.makeId(newType, newLabel), label: newLabel, label, props: {}, edges: [{ source, type: 'suffix' }] })
        }
...
const augment = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        if (prefix || suffix) {
            ...
            results.push({ type: STRING_TYPE, id: this.makeId(STRING_TYPE, newLabel), label: newLabel, label, props: { string: newLabel }, edges: [{ source, type: 'augment' }] })
        }
