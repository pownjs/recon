...
const httpFingerprint = class extends Transform {
    ...
    async handle({ id: source = '', label = '', props, ...rest }, { timeout = DEFAULT_TIMEOUT, augment = DEFAULT_AUGMENT, defuse = DEFAULT_DEFUSE, responseBodySniffSize = DEFAULT_RESPONSE_BODY_SNIFF_SIZE }) {
        const results = []
