...
const { SOFTWARE_TYPE, ISSUE_TYPE, EXPLOIT_TYPE } = require('../../types')
...
const vulnersSearch = class extends Transform {
    ...
    async handle({ id: source = '', label = '' }, options) {
        ...
        const { responseBody } = await this.scheduler.tryRequest({ uri: `https://vulners.com/api/v3/burp/software/?${query}` })
