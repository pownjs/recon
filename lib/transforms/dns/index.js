...
const DEFAULT_RESOLVE_CONCURRENCY = 500
...
const dnsResolve = class extends Transform {
    ...
    static get options() {
        return {
            ...
            resolveConcurrency: {
                ...
                type: 'number',
                default: DEFAULT_RESOLVE_CONCURRENCY
            }
        }
    }
    ...
    async run(items, { resolveConcurrency = DEFAULT_RESOLVE_CONCURRENCY, ...options }) {
        return await super.run(items, options, resolveConcurrency)
    }
}
